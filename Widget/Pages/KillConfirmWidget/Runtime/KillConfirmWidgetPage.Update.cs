...
namespace KillConfirmGameBar
{
    public sealed partial class KillConfirmWidgetPage
    {
        ...
        {
            if (HeaderStatusSection.UpdateButton == null || HeaderStatusSection.VersionText == null || HeaderStatusSection.UpdateIndicatorDot == null)
            {
                return;
            }
            ...
            HeaderStatusSection.UpdateButton.Background = new SolidColorBrush(background);
            HeaderStatusSection.UpdateButton.BorderBrush = new SolidColorBrush(border);
            HeaderStatusSection.VersionText.Foreground = new SolidColorBrush(foreground);
            HeaderStatusSection.UpdateIndicatorDot.Fill = new SolidColorBrush(dot);

            string tooltipBody = ResolveUpdateTooltipBody();
            ToolTipService.SetToolTip(
                HeaderStatusSection.UpdateButton,
