...
namespace KillConfirmGameBar.Controls.GameStyles
{
    public sealed partial class DeltaForceAdvancedEffectsPanel : UserControl
    {
        ...
        {
            SetKillMarkEnabled(KillFeedbackVisibilitySettingsStore.Load(GameStyleMode.DeltaForce).CrosshairEnabled, false);
        }
        ...
        {
            KillFeedbackVisibilitySettingsStore.Save(GameStyleMode.DeltaForce, new KillFeedbackVisibilitySettingsValues { CrosshairEnabled = KillMarkEffectToggle.IsOn });
        }
