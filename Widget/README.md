...
Build this project through the root `..\Build-QuickPackage.ps1` script so the Rust service executable and sound packs are copied into the widget content before the Packaging Project builds the final MSIX.
