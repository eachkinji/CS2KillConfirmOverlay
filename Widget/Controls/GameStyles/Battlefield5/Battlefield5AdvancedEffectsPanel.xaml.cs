    ...
    public sealed partial class Battlefield5AdvancedEffectsPanel : UserControl
    {
        ...
        public void ApplyLanguage(bool isChinese)
        {
            ...
            ImportLockedText.Text = isChinese
                ? "Battlefield 5 视觉资源保持内置，事件声音可在语音标签页中自定义。"
                : "Battlefield 5 visuals stay built in; event sounds can be customized in the Voice tab.";
        }
        ...
        {
            SetKillMarkEnabled(KillFeedbackVisibilitySettingsStore.Load(GameStyleMode.Battlefield5).CrosshairEnabled, false);
        }
        ...
        {
            KillFeedbackVisibilitySettingsStore.Save(GameStyleMode.Battlefield5, new KillFeedbackVisibilitySettingsValues { CrosshairEnabled = KillMarkEffectToggle.IsOn });
        }
