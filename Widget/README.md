...
The widget connects to `ws://127.0.0.1:10087/events`, plays sprite sheets from `Assets\KillConfirm`, and relies on the outer Packaging Project to declare and package the full-trust `KillConfirmService\cskillconfirm.exe` companion.
