...
$references = @('mscorlib.dll','System.dll','System.Core.dll','System.IO.Compression.dll','System.IO.Compression.FileSystem.dll','Facades/System.Runtime.dll','Facades/System.Runtime.InteropServices.WindowsRuntime.dll') | ForEach-Object { '/r:' + (Join-Path $framework $_) }
